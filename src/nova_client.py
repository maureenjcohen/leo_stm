# -*- coding: utf-8 -*-
"""
Created on Thu Jul 25 12:08:40 2019

@author: Maureen

Source is https://github.com/cta-sst-1m/digicampipe/blob/lid_ccd/digicampipe/image/nova_client.py

Nova Client code modified for Python 3 by two users 
